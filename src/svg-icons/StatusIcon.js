...
import styles from "../styles/svg-icons/StatusIcon.module.css";

const StatusIcon = () => {
  const [hasStatuses, setHasStatuses] = React.useState(true);
  ...
  return (
    <div title="Status">{hasStatuses ? withStatuses : withOutStatuses}</div>
  );
};
